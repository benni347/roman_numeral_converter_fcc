function convertToRoman(num) {
  ...
  let roman_number_str = '';

  for (const i of Object.keys(roman_numbers)) {
    const count = Math.floor(num / roman_numbers[i]);
    num -= count * roman_numbers[i];
    roman_number_str += i.repeat(count);
  }

  return roman_number_str;
}
